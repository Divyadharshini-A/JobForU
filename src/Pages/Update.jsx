...
const Update = () => {
    const {id} = useParams();
    //console.log(id)
    const {_id,jobTitle,companyName,minPrice,maxPrice,jobLocation,postingDate,salaryType,
...
{...register("companyName")} defaultValue={companyName} className="create-job-input"/>
      </div>
...
{...register("minPrice")} defaultValue={minPrice} className="create-job-input"/>
      </div>
      <div className='lg:w-1/2 w-full'>
       <label className='block mb-2 text-lg'>Maximum Salary</label>
       <input type="text" placeholder="$120k"
{...register("maxPrice")} defaultValue={maxPrice} className="create-job-input"/>
      </div>
...
{...register("jobLocation")} defaultValue={jobLocation}className="create-job-input"/>
      </div>
     ...
     <div className='lg:w-1/2 w-full'>
       ...
       <input type="date" placeholder="Ex : 2024-03-24" {...register("postingDate")} defaultValue={postingDate} className="create-job-input"/>
      </div>
      <div className='lg:w-1/2 w-full'>
     ...
     <div className='create-job-flex'>
      <div className='lg:w-1/2 w-full'>
       ...
       <input type="url" placeholder="Paste your company URL: Ex: https://www.google.com/" {...register("companyLogo")} defaultValue={companyLogo} className="create-job-input"/>
      </div>
     ...
     <div className='w-full'>
        ...
        rows={6}
        placeholder='job Description....' defaultValue={description}
